...
$$
\frac{\partial L}{\partial x_i} = \sum_{j} \frac{\partial L}{\partial y_j} \cdot \frac{\partial y_j}{\partial x_j}
$$

The first part is given as input to SoftMax.forward(). The second part can be calculated as seen above, depending on whehter $i=j$ or not.
